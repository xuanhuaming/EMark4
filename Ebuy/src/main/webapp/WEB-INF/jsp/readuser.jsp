...
<div class=" container">
	...
	<br>
	<h1><font  color="rgb(68,157,68)">恭喜您成功找回密码</font></p></h1>
          <h3> 您的密码是： <p>${sessionScope.user1.password}</p></h3>
          <br><br><br>
          <hr>
          <div class="col-md-4 col-md-offset-2"><a class="btn btn-success btn-lg" href="loginForm" role="button">我要登录</a></div>
